...
st.write("Columns in the DataFrame: ", pd_df.columns.tolist())

# Check if 'fruit_name' exists
if 'fruit_name' not in pd_df.columns:
    st.error("The 'fruit_name' column does not exist in the DataFrame.")
else:
